"This file is called FourHundredWords2FourDigits_9.py."
"It was forked from FourHundredWords2FourDigits_8.py and modified."
"""Objective of version 9: Enabling a word-labyrinth which yields
a weak password to be saved, so that it can be subsequently loaded
in 'alter' mode and have its weakness fixed."""
import random
import time
...
Name: FourHundredWords2FourDigits_9.py
...
if (mode == "c"):
    ...
    if (ans_CH == "y"):
        data.append(("Executor:", "FourHundredWords2FourDigits_9.py"))
        ...
        print("Executor: FourHundredWords2FourDigits_9.py")
