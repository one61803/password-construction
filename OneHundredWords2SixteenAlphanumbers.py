"This file is called OneHundredWords2SixteenAlphanumbers.py."
"It was forked from OneHundredWords2FourDigits.py and modified."
import random
import time
...
if ans == "y":
    ...
    while not filename_OK:
        ...
        if (len(f_ST) < 6) or not (f_ST[-6:] == ".1H16A"):
        ...
        for line in f:
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if len(line_LS) == 4:
                    ...
                    if (line_LS[0] == "Executor:") and (not line_LS[1] == "OneHundredWords2SixteenAlphanumbers.py"): 
...
codeword_hash = string_hash_6(output)
...
if not is_loaded:
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "OneHundredWords2SixteenAlphanumbers.py"))
