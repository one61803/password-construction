"This file is called FourHundredWords2FourDigits_7.py."
"It was forked from FourHundredWords2FourDigits_6.py and modified."
import random
import time
...
Name: FourHundredWords2FourDigits_7.py
...
def buffer_digit():
    "Prompts the user with a string of 16 random digits and a question mark, asking for the sum modulo 10 of those digits, and re-prompting if the answer is wrong."
    OK = False
    while not OK:
        digit_string = ""
        digit_sum = 0
...
def digit_mask(digit):
    "Writes a line of 16 digits whose sum modulo 10 equals parameter digit. (The first 15 are random and the last one is compensating in order for the sum to equal the target digit.)"
    digit_string = ""
    digit_sum = 0
    for i in range(15):
        new_digit = random.randrange(0, 10)
...
def digit_Western_Arabic_to_Kannada(digit_CH):
    "Converts a string containing one digit (Western Arabic) to Kannada."
...
def encode_to_Kannada(a_string):
    "Converts a string of Western Arabic digits to Kannada."
    new_string = ""
    if is_string(a_string):
        if (len(a_string) == 4):
            ...
            print("L631. ERROR in encode_to_Kannada: The parameter should have four characters.")
    else:
        print("L633. ERROR in encode_to_Kannada: The parameter should be a string.")
...
if (mode == "c"):
    ...
    if ans_CH == "y":
        ...
        print("Executor: FourHundredWords2FourDigits_7.py")
