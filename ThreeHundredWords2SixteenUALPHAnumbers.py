"This file is called ThreeHundredWords2SixteenUALPHAnumbers.py."
"It was forked from TwoHundredWords2SixteenUALPHAnumbers_2.py."
import random
import time

"A filename (of a file processed by the program) should have extension .3H16U."
"The output password has entropy 16*lg(36) = 82.7."
"The password has information entropy 16*((26/31)*lg(31)+(5/31)*lg(62)) = 81.8."
"The input consists of 300 eight-letter words, uppercase."
...
def transnumeration(word_st):
    ...
    if len(lst) == 8:
        ...
        print("L35. ERROR in transnumeration.")
...
def neo_mod(num):
    ...
    if num >= 0:
        ...
        print("L59. ERROR in new_mod: argument num < 0")
    else:
        print("L61. ERROR in new_mod: argument is not a number.")
...
def vector_average(vec_LS):
    ...
    if len(vec_LS) == 8:
        ...
        print("L98. ERROR in vector_average: argument vec_LS has length other than 8.")
...
def phi_ordnum(word_ST):
    ...
    if isproperwordoid(word_ST):
        ...
        print("L165. ERROR in phi_ordnum: argument word_ST is not a proper wordoid.")
...
def if_page_swallow(a_string):
    ...
    if (a_string[0:3] == "P. ") and (a_string[3] in digits_LS):
        ...
        if (a_string[0] == " "):
            ...
            print("L252. ERROR in if_page_swallow: No space after the page number.")
    return a_string
...
def if_paragraph_swallow(a_string):
    ...
    if (a_string[0:5] == "PAR. ") and (a_string[5] in digits_LS):
        ...
        if (a_string[0] == " "):
            ...
            print("L263. ERROR in if_paragraph_swallow: No space after the paragraph number.")
    return a_string
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if len(line_LS) == 4:
                    ...
                    if not line_LS[0] in ["Executor:", "Book:", "Author:", "Publisher:", "Location:", "Codeword hash:"]:
                        print("L327. ERROR: Not an approved first element for an ordered pair.")
                    if (line_LS[0] == "Executor:") and (not line_LS[1] == "ThreeHundredWords2SixteenUALPHAnumbers.py"): 
                        print("L329. ERROR: I am not the executor of this file.")
                        exit()
                    if line_LS[0] == "Book:":
                        the_book = line_LS[1]
                        print("Book: " + the_book + "\n")
                    ...
                    print("L348. len(line_LS) = " + str(len(line_LS)))
                    print("L349. ERROR")
            else:
...
for i in range(1, upper_bound + 1):
    if (mode == "c"):
        ...
        print("L474. ERROR: variable mode should be one of c, r, a.")
    ...
    if i==300 or (is_toy_version and i==12):
...
output = transcharacterization(vecsum_total_300)
output = output.upper()
...
if (mode == "r"):
    ...
    if codeword_hash == the_codeword_hash:
        ...
        print("L514. ERROR: Output's hash is NOT OK.")
...
if (mode == "c"):
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "ThreeHundredWords2SixteenUALPHAnumbers.py"))
