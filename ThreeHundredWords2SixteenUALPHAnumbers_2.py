"This file is called ThreeHundredWords2SixteenUALPHAnumbers_2.py."
...
Name: ThreeHundredWords2SixteenUALPHAnumbers_2.py
Extension of password constructing file: .3H16U
Input work level: 300 words
...
def phi_ordnum(word_ST):
    ...
    if is_proper_keywordoid(word_ST):
        ...
        print("L159. ERROR in phi_ordnum: argument word_ST is not a proper wordoid.")
...
def if_page_then_swallow(a_string):
    ...
    if (a_string[0:3] == "P. ") and (a_string[3] in digits_LS):
        ...
        if (a_string[0] == " "):
            ...
            print("L244. ERROR in if_page_then_swallow: No space after the page number.")
    return a_string
...
def if_paragraph_then_swallow(a_string):
    ...
    if (a_string[0:5] == "PAR. ") and (a_string[5] in digits_LS):
        ...
        if (a_string[0] == " "):
            ...
            print("L255. ERROR in if_paragraph_then_swallow: No space after the paragraph number.")
    return a_string
        ...
        for line in f:
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if len(line_LS) == 4:
                    ...
                    if (line_LS[0] == "Executor:") and (not line_LS[1] == "ThreeHundredWords2SixteenUALPHAnumbers_2.py"): 
...
for i in range(1, upper_bound + 1):
    if (mode == "c"):
        ...
        print("L445. ERROR: variable mode should be one of c, r, a.")
...
if (mode == "c"):
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "ThreeHundredWords2SixteenUALPHAnumbers_2.py"))
        ...
        print("METADATA")
        print("Filename: " + f_ST)
        print("Executor: ThreeHundredWords2SixteenUALPHAnumbers_2.py")        
