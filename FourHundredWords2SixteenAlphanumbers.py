"This file is called FourHundredWords2SixteenAlphanumbers.py."
"It was forked from FourHundredWords2SixteenUALPHAnumbers_2.py."
import random
import time
...
Name: FourHundredWords2SixteenAlphanumbers.py
        ...
        for line in f:
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if len(line_LS) == 4:
                    ...
                    if (line_LS[0] == "Executor:") and (not line_LS[1] == "FourHundredWords2SixteenAlphanumbers.py"): 
...
if (mode == "c"):
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "FourHundredWords2SixteenAlphanumbers.py"))
        ...
        print("METADATA")
        print("Filename: " + f_ST)
        print("Executor: FourHundredWords2SixteenAlphanumbers.py")        
