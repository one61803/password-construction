"This file is called SixHundredWords2FourDigits_3.py."
...
from array import *
my_filename = "SixHundredWords2FourDigits_3.py"
my_associated_file_extension = ".6H4D"

"A filename (of a file processed by the program) should have extension .6H4D."
...
Name: SixHundredWords2FourDigits_3.py
Extension of password constructing file: .6H4D
Input work level: 600 words
    ...
    if not errorFlag:
        ...
        if (ans_CH == "n"):
            ...
            if (antwoord_CH == "y"):
                ...
                print("the log for the post which the password has been assigned to")
                print("guard.\n")
                print("Also play some mind-clearing game or puzzle and make a backup or two")
...
"MAIN"
errorFlag = False
mm = array('i', [150, 300, 450, 600])
nn = array('i', [15, 30, 45, 60])
keywords_LS = []
if (mode == "c"):
    data = [0]
old_vector_left_LS = [0, 0, 0, 0, 0, 0, 0, 0]
