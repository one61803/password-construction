"This file is called FourHundredWords2FourDigits_11.py."
"It was forked from FourHundredWords2FourDigits_10.py and modified."
"""Objectives of version 11: Modify the function swift_alter so that the password is
outputted when it has been successfully created and saved. (It does not need
confirmation because all of the non-seed keywords have remained the same;
they have already been confirmed earlier. Meanwhile, the three seed words are trivial
to input; they just require copying the word that is given in the prompt.)
Also: at the end of 'reconstruct' mode there is now the option to enter swift_alter
mode.
Also in 'alter' mode: when a new, altered, password has been saved, it is
...
Name: FourHundredWords2FourDigits_11.py
...
def swift_alter():
    ...
    if not errorFlag:
        ...
        if (ans_CH == "n"):
            ...
            print("Executor: FourHundredWords2FourDigits_11.py")
        ...
        for line in f:
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if (len(line_LS) == 4):
                    ...
                    if (line_LS[0] == "Executor:") and not (line_LS[1] == "FourHundredWords2FourDigits_11.py"): 
...
if (mode == "c"):
    ...
    if (ans_CH == "y"):
        data.append(("Executor:", "FourHundredWords2FourDigits_11.py"))
