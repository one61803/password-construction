"This file is called TwoHundredWords2SixteenUALPHAnumbers_3.py."
"It was duplicated from TwoHundredWords2SixteenUALPHAnumbers_2.py and modified."
import random
import time
...
Name: TwoHundredWords2SixteenUALPHAnumbers_3.py
Extension of password constructing file: .2H16U
...
def phi_ordnum(word_ST):
    ...
    if is_proper_keywordoid(word_ST):
        ...
        print("L160. ERROR in phi_ordnum: argument word_ST is not a proper wordoid.")
...
if (mode == "r") or (mode == "a"):
    ...
    while not filename_OK:
        ...
        if (len(f_ST) < 7) or not (f_ST[-6:] == ".2H16U"):
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if len(line_LS) == 4:
                    ...
                    if not line_LS[0] in ["Executor:", "Book:", "Author:", "Publisher:", "Location:", "Codeword hash:"]:
                        print("L298. ERROR: Not an approved first element for an ordered pair.")
                    if (line_LS[0] == "Executor:") and (not line_LS[1] == "TwoHundredWords2SixteenUALPHAnumbers_3.py"): 
                    ...
                    print("L319. len(line_LS) = " + str(len(line_LS)))
                    print("L320. ERROR")
            else:
                print("L322. ERROR: Line is not wrapped in parentheses.")
...
for i in range(1, upper_bound + 1):
    if (mode == "c"):
        ...
        print("L435. ERROR: variable mode should be one of c, r, a.")
...
if (mode == "r"):
    if codeword_hash == the_codeword_hash:
        ...
        print("L469. ERROR: Output's hash is NOT OK.")
...
if (mode == "c"):
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "TwoHundredWords2SixteenUALPHAnumbers_3.py"))
        ...
        print("METADATA")
        print("Filename: " + f_ST)
        print("Executor: TwoHundredWords2SixteenUALPHAnumbers_3.py")        
