"This file is called OneHundredWords2SixteenUALPHAnumbers_2.py."
...
"The output password has password entropy 16*lg(36) = 82.7."
...
Name: OneHundredWords2SixteenUALPHAnumbers_2.py
Extension of password constructing file: .1H16U
...
def if_page_then_swallow(a_string):
    ...
    if (a_string[0:3] == "P. ") and (a_string[3] in digits_LS):
        ...
        if (a_string[0] == " "):
            ...
            print("L233. ERROR in if_page_then_swallow: No space after the page number.")
    return a_string
...
def if_paragraph_then_swallow(a_string):
    ...
    if (a_string[0:5] == "PAR. ") and (a_string[5] in digits_LS):
        ...
        if (a_string[0] == " "):
            ...
            print("L244. ERROR in if_paragraph_then_swallow: No space after the paragraph number.")
    return a_string
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if len(line_LS) == 4:
                    ...
                    if not line_LS[0] in ["Executor:", "Book:", "Author:", "Publisher:", "Location:", "Codeword hash:"]:
                        print("L297. ERROR: Not an approved first element for an ordered pair.")
                    if (line_LS[0] == "Executor:") and (not line_LS[1] == "OneHundredWords2SixteenUALPHAnumbers_2.py"): 
                    ...
                    print("L318. len(line_LS) = " + str(len(line_LS)))
                    print("L319. ERROR")
            else:
                print("L321. ERROR: Line is not wrapped in parentheses.")
    is_loaded = True
...
for i in range(1, upper_bound + 1):
    if not is_loaded:
        ...
        print("\nL402. ERROR: is_loaded should be Boolean.")
...
if not is_loaded:
    ...
    if codeword_hash == the_codeword_hash:
        ...
        print("L435. ERROR: Output's hash is NOT OK.")
...
if not is_loaded:
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "OneHundredWords2SixteenUALPHAnumbers_2.py"))
        ...
        print("METADATA")
        print("Filename: " + f_ST)
        print("Executor: OneHundredWords2SixteenUALPHAnumbers_2.py")        
