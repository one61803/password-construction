"This file is called FourHundredWords2SixteenUALPHAnumbers.py."
"It was forked from ThreeHundredWords2SixteenUALPHAnumbers.py."
import random
import time

"A filename (of a file processed by the program) should have extension .4H16U."
...
Name: FourHundredWords2SixteenUALPHAnumbers.py
Extension of password constructing file: .4H16U
Input work level: 400 words
Output password entropy: 82.7 bits
Output information entropy: 81.8 shannons"""
...
def phi_ordnum(word_ST):
    ...
    if isproperwordoid(word_ST):
        ...
        print("L171. ERROR in phi_ordnum: argument word_ST is not a proper wordoid.")
...
def if_page_swallow(a_string):
    ...
    if (a_string[0:3] == "P. ") and (a_string[3] in digits_LS):
        ...
        if (a_string[0] == " "):
            ...
            print("L258. ERROR in if_page_swallow: No space after the page number.")
    return a_string
...
def if_paragraph_swallow(a_string):
    ...
    if (a_string[0:5] == "PAR. ") and (a_string[5] in digits_LS):
        ...
        if (a_string[0] == " "):
            ...
            print("L269. ERROR in if_paragraph_swallow: No space after the paragraph number.")
    return a_string
...
if (mode == "r") or (mode == "a"):
    ...
    while not filename_OK:
        ...
        if (len(f_ST) < 7) or not (f_ST[-6:] == ".4H16U"):
            print("Error: The filename's extension should be .4H16U.")
        else:
            filename_OK = True
    with open(f_ST) as f:
        for line in f:
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if len(line_LS) == 4:
                    ...
                    if not line_LS[0] in ["Executor:", "Book:", "Author:", "Publisher:", "Location:", "Codeword hash:"]:
                        print("L331. ERROR: Not an approved first element for an ordered pair.")
                    if (line_LS[0] == "Executor:") and (not line_LS[1] == "FourHundredWords2SixteenUALPHAnumbers.py"): 
                        print("L333. ERROR: I am not the executor of this file.")
                        exit()
                    if line_LS[0] == "Book:":
                        the_book = line_LS[1]
                        print("Book: " + the_book + "\n")
                    ...
                    print("L352. len(line_LS) = " + str(len(line_LS)))
                    print("L353. ERROR")
            else:
                print("L355. ERROR: Line is not wrapped in parentheses.")
...
for i in range(1, upper_bound + 1):
    if (mode == "c"):
        ...
        print("L464. ERROR: variable mode should be one of c, r, a.")
...
if (mode == "r"):
    ...
    if codeword_hash == the_codeword_hash:
        ...
        print("L494. ERROR: Output's hash is NOT OK.")
...
if (mode == "c"):
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "FourHundredWords2SixteenUALPHAnumbers.py"))
        ...
        while not filename_OK:
            f_ST = input("Enter filename: ")
            if (len(f_ST) < 7) or not (f_ST[-6:] == ".4H16U"):
                print("Error: The filename should have extension .4H16U.")
            else:
                filename_OK = True
        ...
        print("METADATA")
        print("Filename: " + f_ST)
        print("Executor: FourHundredWords2SixteenUALPHAnumbers.py")        
