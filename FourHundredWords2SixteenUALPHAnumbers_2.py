"This file is called FourHundredWords2SixteenUALPHAnumbers_2.py."
"It was forked from FourHundredWords2SixteenUALPHAnumbers.py."
import random
import time
...
Name: FourHundredWords2SixteenUALPHAnumbers_2.py
...
if (mode == "c"):
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "FourHundredWords2SixteenUALPHAnumbers_2.py"))
        ...
        print("METADATA")
        print("Filename: " + f_ST)
        print("Executor: FourHundredWords2SixteenUALPHAnumbers_2.py")        
