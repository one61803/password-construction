"This file is called TwoHundredWords2FourDigits_4.py."
...
Name: TwoHundredWords2FourDigits_4.py
...
def phi_ordnum(word_ST):
    ...
    if is_proper_keywordoid(word_ST):
        ...
        print("L155. ERROR in phi_ordnum: argument word_ST is not a proper wordoid.")
...
def if_page_then_swallow(a_string):
    ...
    if (a_string[0:3] == "P. ") and (a_string[3] in digits_LS):
        ...
        if (len(a_string) > 0) and (a_string[0] == " "):
            ...
            print("L263. ERROR in if_page_then_swallow: No space after the page number.")
            a_string = ""
    return a_string
...
def if_paragraph_then_swallow(a_string):
    ...
    if (a_string[0:5] == "PAR. ") and (a_string[5] in digits_LS):
        ...
        if (len(a_string) > 0) and (a_string[0] == " "):
            ...
            print("274. ERROR in if_paragraph_then_swallow: No space after the paragraph number.")
            a_string = ""
    return a_string
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if len(line_LS) == 4:
                    ...
                    if not line_LS[0] in ["Executor:", "Book:", "Author:", "Publisher:", "Location:", "Codeword hash:"]:
                        print("L336. ERROR: Not an approved first element for an ordered pair.")
                    if (line_LS[0] == "Executor:") and (not line_LS[1] == "TwoHundredWords2FourDigits_4.py"): 
                    ...
                    print("L356. len(line_LS) = " + str(len(line_LS)))
                    print("L357. ERROR")
            else:
                print("L359. ERROR: Line is not wrapped in parentheses.")
    is_loaded = True
...
for i in range(1, upper_bound + 1):
    if not is_loaded:
        ...
        print("\nL441. ERROR: is_loaded should be Boolean.")
...
if not is_loaded:
    ...
    if codeword_hash == the_codeword_hash:
        ...
        print("Error: Output's hash is NOT OK.")
...
if not is_loaded:
    ...
    if ans_CH == "y":
        data.append(("Executor:", "TwoHundredWords2FourDigits_4.py"))
        ...
        print("METADATA")
        print("Filename: " + f_ST)
        print("Executor: TwoHundredWords2FourDigits_4.py")
