"This file is called OneHundredWords2SixteenAlphanumbers_2.py."
"It was forked from OneHundredWords2SixteenAlphanumbers.py and modified."
import random
import time
...
if not is_loaded:
    ...
    while not ((ans_CH == "y") or (ans_CH == "n")):
        ans_CH = input("\nSave (y/n)? ")
    if ans_CH == "y":
        data.append(("Executor:", "OneHundredWords2SixteenAlphanumbers_2.py"))
        ...
        print("Filename: " + f_ST)
        print("Executor: OneHundredWords2SixteenAlphanumbers_2.py")
else:
