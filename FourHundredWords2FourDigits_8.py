...
Name: FourHundredWords2FourDigits_8.py
        ...
        for line in f:
            ...
            if (line[0] == "(") and (line[-1] == ")"):
                ...
                if (len(line_LS) == 4):
                    ...
                    if (line_LS[0] == "Executor:") and not (line_LS[1] == "FourHundredWords2FourDigits_8.py"): 
...
if (mode == "c"):
    ...
    if (ans_CH == "y"):
        data.append(("Executor:", "FourHundredWords2FourDigits_8.py"))
        ...
        print("Executor: FourHundredWords2FourDigits_8.py")
